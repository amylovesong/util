...
public class TestMAC {
	...
	private static void sysOP(String algorithm, byte[] key, String encodedString) {
		System.out.println("\n" + algorithm + "\n" + "key:" + key + "\n"
